    ...
    <section id="über-mich" className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-6xl mx-auto text-center">
        <div className="animate-fade-in">
          <h1 className="text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 mb-8 animate-scale-in">
            Mark Baumann
          </h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-12">
          <div className="animate-scale-in" style={{ animationDelay: '0.4s' }}>
            <img 
              ...
              alt="Mark Baumann"
              className="w-64 h-64 rounded-full object-cover border-4 border-purple-400 shadow-2xl hover:scale-105 transition-transform duration-300"
            />
          </div>
          ...
          <div className="text-left animate-fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <button 
              onClick={downloadCV}
              className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-full hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              <Download size={20} />
